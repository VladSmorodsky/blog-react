    ...
    return <>
        ...
        <div className='grid grid-cols-1'>
            <div className={'pt-16 grid lg:grid-cols-6 md:grid-cols-8 grid-cols-1 gap-2 h-lvh md:overflow-hidden'}>
                <div
                    className={'md:grid relative lg:col-span-1 md:col-span-2 pt-0 min-h-0 border-r border-black-500 hidden'}>
                ...
                <div className='lg:col-span-5 md:col-span-6 md:overflow-auto'>
                    {children}
                </div>
            </div>
        </div>
