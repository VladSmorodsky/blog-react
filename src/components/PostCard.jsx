export const PostCard = ({post}) => {
    return (
        <div
            ...
            <div className={"p-8 "}>{post.title}</div>
            {/*<div aria-hidden="true"*/}
            {/*     className="inset-0 absolute aspect-video border rounded-full -translate-y-1/2 group-hover:-translate-y-1/4 duration-300 bg-gradient-to-b from-blue-500 to-white dark:from-white dark:to-white blur-2xl opacity-25 dark:opacity-5 dark:group-hover:opacity-10"></div>*/}
            ...
            {/*        <svg className="text-[#000014] dark:text-white"*/}
            {/*             xmlns="http://www.w3.org/2000/svg"*/}
            {/*             width="1em" height="1em" viewBox="0 0 128 128">*/}
            {/*            <defs>*/}
            {/*                <linearGradient id="deviconAstro0" x1="882.997" x2="638.955"*/}
            {/*                                y1="27.113"*/}
            {/*                                y2="866.902" gradientTransform="scale(.1)"*/}
            ...
            {/*                                y1="652.45"*/}
            {/*                                y2="1094.91" gradientTransform="scale(.1)"*/}
            {/*                                gradientUnits="userSpaceOnUse">*/}
            ...
            {/*        <p className="text-gray-700 dark:text-gray-300">Amet praesentium*/}
            {/*            deserunt ex*/}
            {/*            commodi tempore fuga voluptatem. Sit, sapiente.</p>*/}
            {/*    </div>*/}

            {/*    <div*/}
            {/*        className="flex gap-3 -mb-8 py-4 border-t border-gray-200 dark:border-gray-800">*/}
            {/*        <a href="#" download="/"*/}
